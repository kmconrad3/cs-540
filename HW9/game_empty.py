...
class TeekoPlayer:
    ...
    def make_move(self, state):
       ...
       #drop_phase = detect_drop_phase()
        ...
        # TODO: implement a minimax algorithm to play better - min value and max value functions
        #move = []
        ...
        #no point of doing everything here if max_value is doing the steps too
    ...
    #Instead of doing the drop phase above doing drop phase here
        ...
        for i in range(len(state)):
            for j in range(len(state[i])):
                if(drop_phase):
                    ...
                    k = i - 1
                    for k in range(max(k,0), min(k+3,4)):
                        x = j - 1
                        for x in range(max(x,0), min(x+3,4)):
    ...
    def heuristic_game_value(self, state):
        ...
        mat = [[0 for x in range(5)] for y in range(2)]
        
        # stored as (y,x)
        loc = [[] for y in range(2)]
    ...
    #Opposite of max value to help the max value function     
